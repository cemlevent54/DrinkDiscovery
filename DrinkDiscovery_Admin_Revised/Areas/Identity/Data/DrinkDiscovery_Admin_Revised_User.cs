...
// Add profile data for application users by adding properties to the DrinkDiscovery_Admin_Revised_User class
public class DrinkDiscovery_Admin_Revised_User : IdentityUser
{
