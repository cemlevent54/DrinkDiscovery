...
namespace DrinkDiscovery_Revised.Areas.Identity.Pages.Account.Manage
{
    public class TwoFactorAuthenticationModel : PageModel
    {
        ...
        public TwoFactorAuthenticationModel(
            UserManager<DrinkDiscovery_Revised_User> userManager, SignInManager<DrinkDiscovery_Revised_User> signInManager, ILogger<TwoFactorAuthenticationModel> logger)
        {
